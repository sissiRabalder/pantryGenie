                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('item.add') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="text-white form-control" name="name" value="{{ $name }}" required autocomplete="name" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="weight" type="number" class="text-white form-control" name="weight" value="{{ $product_quantity }}" required autocomplete="weight">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="expiry_date" type="date" class="text-white form-control" name="expiry_date" value="" required autocomplete="expiry_date">
                            </div>
                        </div>
