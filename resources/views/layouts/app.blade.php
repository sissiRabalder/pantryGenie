...
<head>
    ...
    <title>{{ config('app.name', 'pantryGenie') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md shadow-sm text-white">
            <div class="container">
                <a class="navbar-brand d-flex navbar-dark" href="{{ url('/') }}">
                    <img class="logo p-1" src="{{ url('/images/kreis.svg') }}" alt=""></>
                    <div>{{ config('app.name', 'pantryGenie') }}</div>
                </a>
